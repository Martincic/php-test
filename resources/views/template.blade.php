        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    <a href="{{ route('books.create') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Add book</a> |
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex flex-row flex-wrap justify-center align-center pt-8 sm:justify-start sm:pt-0">
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            <a href="https://martincic.dev" class="ml-1 underline">
                                Tomas Martinčić
                            </a>
                        </div>
                    </div>
